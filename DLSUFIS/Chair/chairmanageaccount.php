...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>CCS<span>ACCREDITATION</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"><span>Faculty</span></h5>
          ...
          <li class="mt">
            <a class="" href="ChairFWSR.php">
              <i class="fa fa-columns"></i>
              <span>Faculty Workload Report</span>
              </a>
          </li>
           <li class="mt">
            <a class="" href="ChairMonitorTasks.php">
              <i class="fa fa-list-ul"></i>
              <span>Monitor Tasks</span>
              </a>
          </li>
        <li class="mt">
            <a class="" href="ChairFacultyEvaluation.php">
              <i class="fa fa-list-alt"></i>
              <span>Faculty Evaluation</span>
              </a>
          </li>
        <li class="mt">
            <a class="" href="ChairInstructionEvaluation.php">
