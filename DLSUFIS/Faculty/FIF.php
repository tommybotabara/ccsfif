            ...
            <div class="row content-panel">
              <div class="panel-heading">
                <ul class="nav nav-tabs nav-justified">
                  <li class="active">
                    <a data-toggle="tab" href="#overview">Profile & Experience</a>
                  </li>
                  <li>
                    <a data-toggle="tab" href="#contact" class="contact-map">Professional Activities 1</a>
                  </li>
                  <li>
                    <a data-toggle="tab" href="#edit">Professional Activities 2</a>
                  </li>
                  <li>
                    <a data-toggle="tab" href="#tabfour">Community Service</a>
                  </li>
                </ul>
              </div>
              <!-- /panel-heading -->
