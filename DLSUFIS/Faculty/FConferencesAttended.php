...
<body>
 ...
 <section id="main-content">
      ...
      <h3>
          <i class="fa fa-angle-right"></i>  Conferences, workshops, seminars, and training programs
          <a href="FCreateConferencesAttended.php"> 
            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  ...
                  <tr>
                    <th><i class=""></i>Conferences, Workshops, Seminars, and Training program</th>
                    <th class="hidden-phone"><i class=""></i>Venue </th>
                 ...
                 <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditConferencesAttended.php?id=".$row['id']."'>";
                          ?>
