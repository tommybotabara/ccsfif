...
<?php
	...
	{
		$ID = $_POST['chosen'];
		$q = "SELECT courseid, termid ,schoolyear, number FROM class where classid = '".$ID."'";
          ...
          while($row = mysqli_fetch_array($lastValueResult)){
              $documentID =$row[0];
				...
				$query="UPDATE class 
                               SET
                                   fid = '$fidd',
                                   courseid = '{$_POST["coursechoose"]}',
                                   termid = '{$_POST["termchoose"]}' ,
                                   schoolyear ='{$_POST["sychoose"]}' ,
                                   number = '{$_POST["num"]}',
          ...
          <div class="col-lg-12">
            ...
            <div class="form-horizontal style-form">
                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						...
						while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
						{
						  ...
						  echo "value={$row['courseid']}>".$row['coursecode']."-".$row['coursename']."</option>";
						}
						?>
						</select>
					</div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="number" class="form-control" name="num" value="<?php echo $number; ?>">
                  </div>
                </div> 
