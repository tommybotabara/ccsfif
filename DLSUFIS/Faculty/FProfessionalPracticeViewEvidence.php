...
<body>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i> View Professional Practice Evidences 
        ...
        <div class="row mt">
          ...
          <div class="">
                <a href="FProfessionalPracticeViewEvidence.php"><button class="btn btn-theme04" type="button">Back</button></a>    
            </div>
