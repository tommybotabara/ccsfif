...
<body>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i> Journal Publication 
          <a href="FCreateJournalPublication.php"> 
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i> Volume Number</th>
                    <th class="hidden-phone"><i class=""></i>Issue Number</th>
                    <th class="hidden-phone"><i class=""></i>Pages</th>
                    <th class="hidden-phone"><i class=""></i>ISI</th>
                  ...
                  <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                      <a download="<?php echo $row[11] ?>" href="uploads/<?php echo $row[11] ?>"> <?php echo $row[10] ?> </a>
                      </td>
                      <td>
                          <?php
                            echo "<a href='FEditJournalPublication.php?id=".$row['id']."'>";
                          ?>
