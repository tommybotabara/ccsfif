              ...
              <table class="table table-striped table-advance">
                ...
                <?php
					...
					$totalall = 0;
							...
							where fid = $fidd
							and c.documentID = doc.ID and doc.isArchived='0';"; 
              ...
              <td>
                      <a download="<?php echo $row['file_uploaded'] ?>" href="uploads/<?php echo $row['file_uploaded'] ?>"> <?php echo $row['file_name'] ?> </a>
							...
							echo'<td>
								...
								<button class="btn btn-primary btn-xs" type="submit" name="chosen" value="'.$row["ID"].'">edit</button>	
								</form>
								</td>';
							?>
							<form action=" <?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal style-form">
									<td>
									<button class="btn btn-danger btn-xs" type="submit" name="delete" value="<?php echo $docid;?>" onclick="return confirm('Are you sure?')"><i class="fa fa-times"></i></button></td>
								</form>
								</tr>
							<?php 
							}
