...
<body>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i> Leadership in Professional Organization   
          <a href="FCreateleadershipInProfOrg.php"> 
                    ...
                    $fidd= $fid['fid'];
                     ...
                     while($row = mysqli_fetch_array($qr)):?>
                      ...
                      <a download="<?php echo $row[6] ?>" href="uploads/<?php echo $row[6] ?>"> <?php echo $row[5] ?> </a>
                          ...
                          <td>
                          <?php
                            echo "<a href='FEditleadershipInProfOrg.php?id=".$row['id']."'>";
                          ?>
