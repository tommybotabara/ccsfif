    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <h2 class="centered" >
              <a href="facultymanageaccount.php"></h2>
              <?php
          ...
          <li class="mt">
            <a class="active" href="FCHTasks.php">
              <i class="fa fa-dashboard"></i>
      ...
      <section class="wrapper">
            ...
            if(!isset($message))
            {
              $insert ="INSERT INTO task 
                        (tasktitle, taskdescription, statusid, faculty_FID, priorityID, duedate, dateassigned, datecompleted, tasktypeID, assignerID)
                        VALUES 
                        ('$tasktitle', '$taskdescription','$status','$yolo', '$taskpriority', '$duedate', '$date', NULL, '$tasktype', '$assigner')";
              ...
              $flag = 1; 
                ...
                $from = new SendGrid\Email("SYSINTG Account Manager", "kirstenmiranda14@gmail.com");
                ...
                $content = new SendGrid\Content("text/html", "
                    Welcome to SYSINTG! This email has been used to create an account. ");
                ...
                $apiKey = ('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');
