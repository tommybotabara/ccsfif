...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="CHdashboardS.php" class="logo"><b>DLSU<span>CCS</span></b></a>
      <!--logo end-->
      ...
      <section class="wrapper">
        <h3>
          ...
          <button type="button" class="btn btn-danger">Back</button> 
            ...
            <h5>See members who haven't accomplished the task:<b> <?php echo $_GET['id']; ?></b>.</h5>
        </h3>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                if (isset($_GET["id"])){
                    $id = $_GET['id'];
                    $query = "SELECT * FROM `task` LEFT JOIN `faculty` ON task.faculty_FID = faculty.FID WHERE taskDescription = '$id' ORDER BY faculty.FID";
                                
                    // print full names and departments of faculty who haven't submitted yet
