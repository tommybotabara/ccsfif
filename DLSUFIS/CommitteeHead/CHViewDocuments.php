    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            <a class="active" href="CHViewDocuments.php">
              <i class="fa fa-dashboard"></i>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>12000.00$ </td>
                    <td>
                      <a href="SaEditAccounts.php" ><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button> </a>
