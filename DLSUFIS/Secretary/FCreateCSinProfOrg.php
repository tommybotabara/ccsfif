...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a  href="FCSinProfOrg.php">In Professional Organization</a></li>
 ...
 <section id="main-content">
       ...
       if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
          ...
          if(!isset($message))
          {
            $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$description."_".$start_date."_"."CommServiceProfessionalOrg";
              echo "$combineName";
    ...
    echo '<font color="red">'.$message.'</font>';
      ...
      ?>
       <h2>  Add New Community Service in Professional Organizations (Local and International) since 2005 </h2>
          ...
          <div class="col-lg-12">
            ...
            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Description of Involvement/Service/Work <font color="red">*</font></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="FCSinProfOrg.php"><button class="btn btn-theme04" type="button">Back</button></a>
                  </div>
                </div>
