        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            ...
            <ul class="sub">
              ...
              <li class="active"><a  href="FProfessionalExperience.php">Professional Experience</a></li>
...
-->         </a></li>
 ...
 <section id="main-content">
      ...
      <h3>
          <i class="fa fa-angle-right"></i> Professional Experience  
          <a href="FCreateProfessionalExperience.php"> 
        ...
        <div class="col-lg-12">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    <th><i class=""></i> Year Passed</th>
                    <th class="hidden-phone"><i class=""></i>Licensure Title </th>
                    <th class="hidden-phone"><i class=""></i>Licensure Number</th>
                    <th class="hidden-phone"><i class=""></i>Date Validity</th>
                ...
                <tbody>
                    ...
                    $fidd= $fid['fid'];
                     ...
                     while($row = mysqli_fetch_array($qr)):?>
                      ...
                      <td>
                      <a download="<?php echo $row[6] ?>" href="uploads/<?php echo $row[6] ?>"> <?php echo $row[5] ?> </a>
                      </td>

                          <td>
                          <?php
                            echo "<a href='FEditProfessionalExperience.php?id=".$row['id']."'>";
                          ?>
