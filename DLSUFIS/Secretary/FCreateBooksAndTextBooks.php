...
?>
      <h2> Add New Books and Text Books [Since 2005] </h2>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    <button class="btn btn-theme" type="submit">Add New</button>
                    <a href="FBooksAndTextbooks.php"><button class="btn btn-theme04" type="button">Back</button></a>
                  </div>
                </div>
