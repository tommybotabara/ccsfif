...
-->         </a></li>
 ...
 <section id="main-content">
      ...
      <h2>  Edit Community Service in Professional Organizations (Local and International) since 2005 </h2>
            ...
            <div class="form-panel">
              <form class="form-horizontal style-form" method="get">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Description of Involvement/Service/Work</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Project/ Activity Site</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
