...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <!-- since 2005 -->
              ...
              <li class="active"> <a href="FPlayScreenplay.php">Play, screenplay, film & etc.</a></li>
 ...
 <section id="main-content">
      ...
      <h3>
          <i class="fa fa-angle-right"></i>  Play, screenplay, film, creative work performed or presented (since 2005)
          <a href="FCreatePlayScreenPlay.php"> 
            ...
            <table class="table table-striped table-advance table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Venue of Performance / Presentation  </th>
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    $fidd= $fid['fid'];
                      ...
                      $q="SELECT p.pub_code AS id, f.flname, p.paper_title, p.venue_performance, p.date_publication 
                     ...
                     <td><?php echo $row['flname'];?><div></td>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditPlayScreenPlay.php?id=".$row['id']."'>";
                          ?>
