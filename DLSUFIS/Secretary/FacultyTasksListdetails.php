    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            <a class="active" href="FacultyTasksList.php">
              <i class="fa fa-tasks"></i>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <thead>
                  <tr>
                    <th><i class="fa fa-bullhorn"></i> Task Ttile</th>
                ...
                <tr>
                    ...
                    <td>
                      <?php echo $row['assignerName'];?>
                    </td>
                    
                    <td>
                        
                    <?php
                            echo "<a href='FacultyTasksList.php?check_task=".$row['taskid']."'>";
                        ?> 
                ...
                <a href="FacultyTasksList.php"><button class="btn btn-theme04" type="button">Back</button></a>
