...
-->         </a></li>
 ...
 <section id="main-content">
      ...
      <h3>
          <i class="fa fa-angle-right"></i> Community Service in Others (e.g. NGOs, advocacy groups, neighborhood associations, local communities, Rotary, Lions, church, faith, and community) 


          <a href="FCreateCSinOthers.php"> 
                  ...
                  <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditCSinOthers.php?id=".$row['id']."'>";
                          ?>
