...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="FOutstandingAchievement.php">Outstanding Achievement/Awards</a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i> Outstanding Achievement    
          <a href="FCreateOutstandingAchievement.php"> 
          <button type="button" class="btn btn-success">Add New </button> 
          </a>
        </h3>
        <p>  Outstanding Achievements/Awards/Recognition Received </p> <!---received since-->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    <th><i class=""></i>Achievements/Awards</th>
                    <th class="hidden-phone"><i class=""></i>Awarding Body </th>
                    <th class="hidden-phone"><i class=""></i>Award Date</th>
                  ...
                  <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     while($row = mysqli_fetch_array($qr)):?>
                      ...
                      <td>
                      <a download="<?php echo $row[5] ?>" href="uploads/<?php echo $row[5] ?>"> <?php echo $row[4] ?> </a>
                    </td>
                          <td>
                          <?php
                            echo "<a href='FEditOutstandingAchievement.php?id=".$row['id']."'>";
                          ?>
