...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <!-- since 2005 -->
              ...
              <li class="active" ><a href="FOtherResearchOutputs.php">Other research outputs</a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <h3>
          <i class="fa fa-angle-right"></i>  Other research outputs (working papers; research reports; conference papers/posters, etc) since 2005
          <a href="FCreateOtherResearchOutputs.php"> 
             ...
             <div class="content-panel">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Remarks </th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                ...
                <?php
                    ...
                    $fidd= $fid['fid'];
                      ...
                      $q="SELECT p.pub_code AS id, f.flname, p.paper_title, p.paper_type, p.date_publication, p.remarks 
                     ...
                     <tr>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditOtherResearchOutputs.php?id=".$row['id']."'>";
                          ?>
