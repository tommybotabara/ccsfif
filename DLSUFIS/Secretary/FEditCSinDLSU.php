...
-->         </a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>Edit Community Service in DLSU (Department, Unit, College, University) Activities (since 2005)</h3>
            ...
            <div class="form-panel">
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Description of Involvement/Service/Work Done</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Committee</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
