 ...
 <section id="main-content">
      ...
      if (isset($_POST['submit']))
      {
       ...
       if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
          ...
          {
              $designation = "";
              $message.='<p>You forgot to select the Designation !';
          }
          else
          ...
          if(!isset($message))
          {
            ...
            $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$designation."_".$org_name."_"."MPO";
              echo "$combineName";
          ...
          while($row = mysqli_fetch_array($lastValueResult)){
              ...
              $result = mysqli_query($dbc, $query);
              $message="<div class='alert alert-success'> <b>  Membership in Professional Organization Successfully added!</b></div>";
              $flag = 1;
...
?>
        <h2> Create Membership in Professional Organization </h2>
        <div class="row mt">
          <div class="col-lg-12">
              ...
              <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="Fm.php"><button class="btn btn-theme04" type="button">Back</button></a>
                  </div>
                </div>
              </form>
