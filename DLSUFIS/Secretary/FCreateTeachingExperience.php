...
<body>
  <section id="container">
    <!-- **********************************************************************************************************************************************************
        TOP BAR CONTENT & NOTIFICATIONS sad
        *********************************************************************************************************************************************************** -->
    <!--header start-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            ...
            <ul class="sub">
              ...
              <li class="active" ><a href="FTeachingExperience.php">Teaching Experience and Length of Service</a></li>
 ...
 <section id="main-content">
      ...
      if (isset($_POST['submit']))
      {
       ...
       if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
          ...
          if (empty($_POST['educ_level']))
          {
              $EL_ID = "";
              $message.='<p>You forgot to enter education level !';
          }
          else
              $EL_ID = $_POST['educ_level'];

          
          if (empty($_POST['no_years']))
          {
              $no_years = "";
              $message.='<p>You forgot to enter number of years!';
          }
          else
              $no_years = $_POST['no_years'];


          if (empty($_POST['INSTITUTION_ID']))
          {
              $institution_id = "";
              $message.='<p>You forgot to select the Institution !';
          }
          else
          ...
          if(!isset($message))
          {
            ...
            $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$row11['POSITION_TITLE']."_"."Teaching Experience";
              echo "$combineName";
          ...
          while($row = mysqli_fetch_array($lastValueResult)){
              ...
              $query = "INSERT INTO teaching_experience 
                            (fid, 
                             el_id, 
                             no_years, 
                             institution_id, 
              ...
              $result = mysqli_query($dbc, $query);
              $message="<div class='alert alert-success'> <b>  Teaching Experience
               Successfully added!</b></div>";
              $flag = 1;
    ...
    echo '<font color="red">'.$message.'</font>';
      ...
      ?>
         <h3> Add New Teaching Experience and Length of Service </h3>
        <div class="row mt">
          <div class="col-lg-12">
          ...
          <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Education Level <font color="red">*</font></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">No. of Years <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="no_years" value="<?php if (isset($_POST['no_years']) && !$flag) echo $_POST['no_years']; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                   <input class="form-control form-control-inline input-medium" size="16" type="date" name="end_date" value="<?php if (isset($_POST['end_date']) && !$flag) echo $_POST['end_date']; ?>">
                    <span class="help-block">Select date or ongoing?</span>
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Postion <font color="red">*</font></label>
                  <div class="col-sm-10">
