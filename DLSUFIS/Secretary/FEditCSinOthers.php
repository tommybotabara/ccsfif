...
-->         </a></li>
 ...
 <section id="main-content">
      ...
      <h2> Edit Others (e.g. NGOs, advocacy groups, neighborhood associations, local communities, Rotary, Lions, church, faith, and community) since 2005
</h2>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Organization</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Project Site</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
