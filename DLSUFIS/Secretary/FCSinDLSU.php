...
-->         </a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i>   In DLSU (Department, Unit, College, University) Activities
          <a href="FCreateCSinDLSU.php"> 
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Committee</th>
                ...
                <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditCSinDLSU.php?id=".$row['id']."'>";
                          ?>
