            ...
            <ul class="sub">
              ...
              <!--  In Professional Organizations (Local and International) since 2005 -->
               ...
               <!-- With Government Organizations and Agencies (since 2005) x -->
                <li class="active"><a  href="FCSinOthers.php">Others</a></li>
 ...
 <section id="main-content">
      ...
      if (isset($_POST['submit']))
      {
       ...
       if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
          ...
          {
              $others = "";
              $message.='<p>You forgot to enter others !';
          }
          else
              $others = $_POST['others'];
          ...
          if(!isset($message))
          {
            ...
            $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$description."_".$start_date."_"."CommServiceInOthers";
              echo "$combineName";
          ...
          while($row = mysqli_fetch_array($lastValueResult)){
              ...
              $result = mysqli_query($dbc, $query);
              $message="<div class='alert alert-success'> <b>  Community Service in DLSU Successfully added!</b></div>";
              $flag = 1;
    ...
    echo '<font color="red">'.$message.'</font>';
      ...
      ?>
         <h2> Create Others (e.g. NGOs, advocacy groups, neighborhood associations, local communities, Rotary, Lions, church, faith, and community)
</h2>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">    
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Organization <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="others" value="<?php if (isset($_POST['others']) && !$flag) echo $_POST['others']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Project Site <font color="red">*</font></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="FCSinOthers.php"><button class="btn btn-theme04" type="button">Back</button></a>
                  </div>
                </div>
