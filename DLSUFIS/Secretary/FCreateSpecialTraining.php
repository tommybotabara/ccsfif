...
<?php
       ...
       if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
          ...
          if(!isset($message))
          {
            ...
            $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$training_title."_".$INSTITUTION_ID."_"."ST";
              echo "$combineName";
          ...
          while($row = mysqli_fetch_array($lastValueResult)){
              ...
              $query101 = "INSERT INTO special_training 
                              (FID, 
                               TRAINING_TITLE, 
                               VENUE, 
                               START_DATE, 
              ...
              $result101 = mysqli_query($dbc, $query101);
              $message="<div class='alert alert-success'> <b> Special Training Successfully added!</b></div>";
              $flag = 1;
    ...
    ?>
        ...
        <h3>Add New Special Training </h3>
        <div class="row mt">
          <div class="col-lg-12">               
          ...
          <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Training Title <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="training_title" value="<?php if (isset($_POST['training_title']) && !$flag) echo $_POST['training_title']; ?>">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Institution/Organization <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Institution" value="<?php if (isset($_POST['Institution']) && !$flag) echo $_POST['Institution']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Venue[City, Country] <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="venue" value="<?php if (isset($_POST['venue']) && !$flag) echo $_POST['venue']; ?>">
                  </div>
                </div>
                <div class="form-group">
