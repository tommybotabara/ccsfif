...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <!-- since 2005 -->
              ...
              <li class="active"><a  href="FPublishedPapers.php">Papers Published in conference proceedings</a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i>  Papers published in conference proceedings
          <a href="FCreatePublishedPapers.php"> 
          ...
          <div class="col-lg-12">
            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">        
                <thead>
                  <tr>
                    <th><i class=""></i>Author[s]
                    </th>
                    <th class="hidden-phone"><i class=""></i>Title of Paper </th>
                    <th class="hidden-phone"><i class=""></i>Title of Conference Proceedings</th>
                    <th class="hidden-phone"><i class=""></i>Publisher</th>
                    <th class="hidden-phone"><i class=""></i>Place of Publication</th>
                    <th class="hidden-phone"><i class=""></i>Date of Publications</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                          ...
                          $fidd= $fid['fid'];
                            ...
                            $q="SELECT p.pub_code AS id, f.flname, p.paper_title, p.conf_title, p.publisher, p.place_publication, p.pages, p.date_publication 
                                 FROM faculty f, publication p, publication_type pt
                                WHERE p.fid = $fidd
                                  AND f.fid = p.fid
                                  AND p.pub_type = pt.pt_id
                                  AND p.pub_type='PT007'
                           ...
                           <tr>
                            ...
                            <td>
                                <?php
                                  echo "<a href='FEditPublishedPapers.php?id=".$row['id']."'>";
                                ?>
