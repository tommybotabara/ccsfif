        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            ...
            <ul class="sub">
              ...
              <li class="active" ><a  href="FProfessionalPractice.php">Professional Practice Outside
...
-->         </a></li>
 ...
 <section id="main-content">
       ...
       if(!isset($_FILES['file']) || $_FILES['file']['error'] == UPLOAD_ERR_NO_FILE) {
          ...
          if(!isset($message))
          {
             ...
             $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$work_nature."_"."ProfessionalPractice";
          ...
          while($row = mysqli_fetch_array($lastValueResult)){
              ...
              $query = "INSERT INTO professional_prac
                                  (fid, 
                                   work_nature, 
                                   Institution, 
                                   no_years, 
              ...
              $result = mysqli_query($dbc, $query);
              $message="<div class='alert alert-success'> <b>  Professional Practice Successfully added!</b></div>";
              $flag = 1;
          }    
    ...
    echo '<font color="red">'.$message.'</font>';
      ...
      ?>
        <h2> Add New Professional Practice</h2>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nature of the Project/Practice <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name = "work_nature" value="<?php if (isset($_POST['work_nature']) && !$flag) echo $_POST['work_nature']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Education Institution <font color="red">*</font></label>
                  <div class="col-sm-10">
                      <input type= "text" class="form-control" id="INSTITUTION_ID" name="INSTITUTION_ID" value="<?php if (isset($_POST['work_nature']) && !$flag) echo $_POST['work_nature']; ?>">
                    </div>
                </div>  
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="FProfessionalPractice.php"><button class="btn btn-theme04" type="button">Back</button></a>
                  </div>
                </div>
              </form>
