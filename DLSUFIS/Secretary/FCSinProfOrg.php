...
-->         </a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i>   In Professional Organizations (Local and International) since 2005

          <a href="FCreateCSinProfOrg.php"> 
                 ...
                 <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditCSinProfOrg.php?id=".$row['id']."'>";
                          ?>
