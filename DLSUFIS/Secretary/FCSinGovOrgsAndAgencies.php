...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <!--  In Professional Organizations (Local and International) since 2005 -->
               <li class="active"><a  href="FCSinGovOrgsAndAgencies.php">With Government Organizations and Agencies</a></li>
 ...
 <section id="main-content">
      ...
      <h3>
          <i class="fa fa-angle-right"></i>   With Government Organizations and Agencies
          <a href="FCreateCSinGovOrgsAndAgencies.php"> 
        ...
        <div class="row mt">
          <div class="col-lg-12">
              <div class="content-panel">
                ...
                <thead>
                  <tr>
                    <th><i class=""></i> Description of Involvement/Service/Work Done</th>
                    <th class="hidden-phone"><i class=""></i>Government Organization and Agencies</th>
                    <th class="hidden-phone"><i class=""></i>Project/ Activity Site</th>
                ...
                <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                      <a download="<?php echo $row[7] ?>" href="uploads/<?php echo $row[7] ?>"> <?php echo $row[6] ?> </a>
                      </td>
                      <td>
                          <?php
                            echo "<a href='FEditCSinGovOrgsAndAgencies.php?id=".$row['id']."'>";
                          ?>
