...
-->         </a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <h3>
          <i class="fa fa-angle-right"></i> Teaching Experience and Length of Service
          <a href="FCreateTeachingExperience.php"> 
            ...
            <table class="table table-striped table-advance table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Institution Name</th>
                    <th class="hidden-phone"><i class=""></i>Start Date </th>
                    <th class="hidden-phone"><i class=""></i>End Date</th>
                    <th class="hidden-phone"><i class=""></i>Position </th>
                ...
                <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     while($row = mysqli_fetch_array($qr)):?>
                      ...
                      <td>
                      <a download="<?php echo $row[8] ?>" href="uploads/<?php echo $row[8] ?>"> <?php echo $row[7] ?> </a>
                      </td>
                          <td>
                          <?php
                            echo "<a href='FEditTeachingExperience.php?id=".$row['id']."'>";
                          ?>
