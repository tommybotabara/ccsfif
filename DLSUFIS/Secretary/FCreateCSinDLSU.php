...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a  href="FCSinDLSU.php">In DLSU</a></li>
 ...
 <section id="main-content">
    ...
    $message = NULL;
          ...
          if(!isset($message))
          {
            $query10="select FFNAME, FLNAME 
              ...
              $combineName = $row10['FLNAME']."_".$row10['FFNAME']."_".$description."_".$start_date."_"."CommServiceDLSU";
              echo "$combineName";
    ...
    echo '<font color="red">'.$message.'</font>';
      ...
      ?>
         <h3>Add new Community Service in DLSU (Department, Unit, College, University) Activities </h3>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal style-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Committee <font color="red">*</font></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="committee" value="<?php if (isset($_POST['committee']) && !$flag) echo $_POST['committee']; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <a href="FCSinDLSU.php"><button class="btn btn-theme04" type="button">Back</button></a>
                  </div>
                </div>
              </form>    
