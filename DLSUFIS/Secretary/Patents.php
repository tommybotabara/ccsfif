...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <!-- since 2005 -->
              ...
              <li class="active"><a  href="Patents.php">Patents</a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i> Patents
          <a href="FCreatePatents.php"> 
               ...
               <div class="content-panel">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Issuing Country</th>
                    <th class="hidden-phone"><i class=""></i>Patent No</th>
                  ...
                  <?php
                    ...
                    $fidd= $fid['fid'];
                     ...
                     <tr>
                      ...
                      <td>
                          <?php
                            echo "<a href='FEditPatents.php?id=".$row['id']."'>";
                          ?>
