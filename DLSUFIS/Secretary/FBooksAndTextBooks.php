...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <!-- since 2005 -->
              ...
              <li class="active"><a  href="FBooksAndTextbooks.php">Books and Textbooks</a></li>
 ...
 <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>
          <i class="fa fa-angle-right"></i> Books and Textbooks 
          <a href="FCreateBooksAndTextBooks.php"> 
          ...
          <div class="col-lg-12">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Publication Date</th>
                    <th class="hidden-phone"><i class=""></i>ISBN</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
               <?php
                          ...
                          $fidd= $fid['fid'];
                            ...
                            $q="SELECT p.pub_code AS id, f.flname, p.paper_title, p.publisher, p.place_publication, p.date_publication, p.isbn 
                           ...
                           <tr>
                            ...
                            <td>
                                <?php
                                  echo "<a href='FEditBooksAndTextBooks.php?id=".$row['id']."'>";
                                ?>
