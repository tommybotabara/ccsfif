...
-->         </a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
            <!-- since 2005 -->
              <li class="active"  ><a href="FJournalPublication.php">Journal Publication</a></li>
 ...
 <section id="main-content">
      ...
      <h2> Edit Journal Publication </h2>
        <div class="row mt">
          <div class="col-lg-12">
             <div class="form-panel">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Volume Number</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div><div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Issue Number</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
