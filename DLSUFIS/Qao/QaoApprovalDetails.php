            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    <th> Faculty </th>
                    <th><i class="fa fa-bullhorn"></i> Task Title</th>
                ...
                $brothers = mysqli_query($dbc, $jonas);
                  ...
                  <tr>
                    <td> <?php echo $row['ffname'];echo ", "; echo $row['flname']; ?></td>  
                    <td>
              ...
              <a href="QaoApproval.php"><button class="btn btn-danger">Back</button></a>
            </div>
