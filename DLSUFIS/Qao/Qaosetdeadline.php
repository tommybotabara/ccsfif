      ...
      <section class="wrapper">
            ...
            if(!isset($message))
            {
              $insert ="INSERT INTO Reminders
						(`title`, `description`, `date`, `interval`, `Assignto`, `active`, `reminderSent`)
                        VALUES 
                        ('$Remindertitle', '$reminderdescription','$datereminder', '$intervalschedule', '$assign', 1, 0)";
              ...
              <table id="sampleTable" class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>Interval</th>
                    <th class="hidden-phone"><i class=""></i>Assgined to</th>
                    <th></th>
                    </tr>
                </thead>
                <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $row['interval'];?></div></td>
                  <td><?php echo $row['position_title'];?></div></td>
    
                <td>
					<?php 
						if($row['active'] == 1)
							echo  '<button class="btn btn-danger btn-xs">Deactivate</button>';
						else
							echo  '<button class="btn btn-success btn-xs">Activate</button>';
					?>				
				</td>
