...
<section id="container">
 <!-- **********************************************************************************************************************************************************
     ...
     <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a  class="active" href="QaoFacultySummaryEvidence.php">
    ...
    <!-- **********************************************************************************************************************************************************
      ...
      <h3>
          <i class="fa fa-angle-right"></i> Faculty Summary Evidence   
          </a>
        </h3>
		...
		<tbody>
                ...
                <?php
                    ...
                    $fidd= $fid['fid'];
                      ...
                      $q="SELECT fid as id, flname, ffname, fmname, unit_code, dept as dept_code, rank, classification as class, account_id  
                                  FROM faculty
                                "; 
                     ...
                     <tr>
                      ...
                      <td><?php echo $row['dept_code'];?></div></td>
