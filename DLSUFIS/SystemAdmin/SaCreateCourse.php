...
<section id="main-content">
      <section class="wrapper">
              <h3>
                <i class="fa fa-angle-right"></i> Create Course   
        ...
        <div class="row mt">
          ...
          <div class="form-panel">
            ...
            <div class="form-group">
					...
					<div class="form-group">
					<label class="col-sm-2 col-sm-2 control-label">Units </label>
					<div class="col-sm-2">
                    <input type="text" class="form-control" name="title">
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-2 col-sm-2 control-label">Hours </label>
					<div class="col-sm-2">
						<input type="text" class="form-control" name="title">
					</div>
                    </div>
                <input class="btn btn-theme" type="submit" name="Submit" value="Submit">
                <a href="SaCourses.php"><button type="button" class="btn btn-primary">Back</button>
