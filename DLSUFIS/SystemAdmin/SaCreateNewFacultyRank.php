...
<?php
	...
	if (isset($_POST['Submit']))
	{
		...
		if(!isset($message))
		{
			...
			$q = "select count(id) as id from rank;";
			...
			$query="insert into rank (id, rank_code, rank_title, active) values ('{$count}','{$_POST["code"]}','{$_POST["title"]}','1')";
			$result=mysqli_query($dbc,$query);
			$success = "New rank (".$_POST['code']."-".$_POST['title'].") has been created.";
		}				
	}
...
<section id="main-content">
      <section class="wrapper">
              <h3>
                <i class="fa fa-angle-right"></i> Create New Faculty Rank     
