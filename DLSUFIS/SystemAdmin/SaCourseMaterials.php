  ...
  <section id="container">
   ...
   <?php
    ...
    <section id="main-content">
      ...
      <h3>
          <i class="fa fa-angle-right"></i> Course  Materials
          <a href="SaCreateCourseMaterials.php"> 
                  ...
                  <?php
					...
					{ 
						...
						<tr>
                            ...
                            ;
							echo'		<td>
									<form action="SaEditCourseMaterials.php" method="post" class="form-horizontal style-form">
