                  ...
                  <div class="col-sm-2">
                    <select class="form-control" id="schoolyear" name="schoolyear">
                        <?php
                          ...
                          {
                              echo "<option value={$row1['syid']}>{$row1['schoolyearstart']}-{$row1['schoolyearend']}</option>";
                          }
                        ?>
                    </select>
                  </div>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class=""></i>S.Y. Start</th>
                    <th class="hidden-phone"><i class=""></i>S.Y. End</th>
                ...
                <?php
                    ...
                    $fidd= $fid['fid'];
                      ...
                      $q="SELECT 
                            c.totalnum, cr.coursename, cr.units, f.flname, f.ffname, sy.schoolyearstart, sy.schoolyearend, sy.term
                            FROM
                            class c, courses cr, schoolyear sy, faculty f
                             WHERE
                         ...
                         <tr>
                         <td><?php echo $row['flname']; echo ", "; echo$row['ffname'];?></div></td>
                          <td><?php echo $row['coursename'];?></div></td>
                          <td><?php echo $row['units'];?></div></td>
                          <td><?php echo $row['schoolyearstart'];?></div></td>
                          <td><?php echo $row['schoolyearend'];?></div></td>
                          <td><?php echo $row['term'];?></div></td>
                          <td>
