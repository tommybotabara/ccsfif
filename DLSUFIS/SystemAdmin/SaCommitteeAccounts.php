...
<section id="main-content">
      <section class="wrapper">
        <h3>
          <i class="fa fa-angle-right"></i> User Account Records (COMMITTEE HEAD)  
          <a href="SaCreateCommitteeHead.php"> 
          <button type="button" class="btn btn-success">Add New Committee Head</button> 
          </a>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
				<?php
					$qch = "SELECT * FROM ccsfif.committee_head where status = '1';";
					$qrch = mysqli_query($dbc, $qch);
					while($rowch=mysqli_fetch_array($qrch,MYSQLI_ASSOC))
					{
						$fid = $rowch['fid'];
						$q = "SELECT * FROM ccsfif.faculty where active='1' and FID = $fid;";
