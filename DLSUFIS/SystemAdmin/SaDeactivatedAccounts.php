...
<section id="main-content">
      <section class="wrapper">
        <h3>
		  ...
		  <button type="button" class="btn btn-success">View Active Accounts</button> 
		  </a>
        </h3>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
				<?php
					$q = "SELECT FID, FFNAME,FLNAME,DEPT,UNIT_CODE,ACCOUNT_ID, ACTIVE FROM ccsfif.faculty where active='0';";
