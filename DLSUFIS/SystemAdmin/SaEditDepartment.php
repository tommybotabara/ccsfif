...
<?php
	...
	{
		$ID = $_POST['Submit'];
		$q = "SELECT ID, dept_code, dept_name, ACTIVE FROM ccsfif.department where ID = '".$ID."';";
	...
	if(!isset($message))
	{
		$query = "UPDATE `ccsfif`.`department` SET `dept_CODE`='{$_POST['code']}', `dept_name`='{$_POST['name']}',`ACTIVE`='{$_POST['stat']}' WHERE `id`='{$_POST['ID']}';";
		$result=mysqli_query($dbc,$query);
		$success = "Rank (".$_POST['code']." ".$_POST['name'].") has been updated.";
	}					
	}
?>
 ...
 <?php
   ...
   <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>  Edit Department</h3>
